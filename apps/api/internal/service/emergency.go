...
func (s *EmergencyService) GetAll() ([]domain.Emergency, error)                                   { return s.repo.FindAll() }
func (s *EmergencyService) GetByProvince(id string) ([]domain.Emergency, error)                   { return s.repo.FindByProvince(id) }
func (s *EmergencyService) GetByRegency(id string) ([]domain.Emergency, error)                    { return s.repo.FindByRegency(id) }
func (s *EmergencyService) GetDispatchers(r, p string) ([]domain.Emergency, error)                { return s.repo.FindDispatchers(r, p) }
func (s *EmergencyService) GetByType(id string) ([]domain.Emergency, error)                       { return s.repo.FindByType(id) }
func (s *EmergencyService) GetByIDs(ids []string) ([]domain.Emergency, error)                     { return s.repo.FindByIDs(ids) }
func (s *EmergencyService) Create(e domain.Emergency) (*domain.Emergency, error)                  { return s.repo.Create(e) }
func (s *EmergencyService) Update(e domain.Emergency) (*domain.Emergency, error)                  { return s.repo.Update(e) }
...
func (s *EmergencyService) UpdateType(t domain.EmergencyType) (*domain.EmergencyType, error)     { return s.typeRepo.UpdateType(t) }
