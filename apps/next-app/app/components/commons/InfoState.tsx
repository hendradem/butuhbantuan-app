...
const InfoState: React.FC<Props> = ({ title, description, cta, size }) => {
    return (
        <div className=" bg-white flex items-center justify-center px-8 py-3">
            <div className="text-center max-w-md">
                ...
                <div className="mb-3 relative flex items-center justify-center">
                    <Image
                        src="/assets/illustration/core/search.svg"
                ...
                {/* Description */}
                <p className="text-gray-600 text-[15px] mb-3 leading-tight">
                    {description}
                </p>
