...
import { useEmergencyType } from "@/app/store/api/emergency.api";
...
const MainBottomMenu: React.FC<MapsPropsType> = ({ rebuildMap }) => {
  const {
    ...
    isLoading: emergencyTypeLoading,
    refetch: refetchEmergencyType,
  } = useEmergencyType();
  ...
  useEffect(() => {
    if (
      ...
      handleSelectedEmergency(selectedEmergencyDataState.selectedEmergencyData);
      scrollToTop();
    }
  }, [selectedEmergencyDataState]);
                ...
                <div className="detail-sheet">
                      ...
                      <div>
                        ...
                        <p className="m-0 text-[14px] text-neutral-500">
                          ...
                          <span
                            ...
                            onClick={() => handleChangeLocationOnClick()}
                          >
                            Ganti lokasi
                          </span>
                        </p>
                  ...
                  <div className="sheet-body search-result-wrapper bg-neutral-50 max-h-[300px] overflow-y-scroll">
                    <div className="mt-5">
                      ...
                      {emergencyData &&
                        emergencyData?.map(
                          (emergency: any, emergencyIndex: number) => {
                            return (
                              <div
                                key={emergencyIndex}
                                    ...
                                    <div className="card-footer mt-4">
                                      <div className="flex gap-2">
                                        <button
                                          ...
                                          disabled={
                                            emergency?.contact.whatsapp == null
                                          }
