...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/h3@1.15.5/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/@vue+shared@3.5.28/node_modules/@vue/shared/dist/shared.cjs.js';
import { sub } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/date-fns@4.1.0/node_modules/date-fns/index.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/vue-bundle-renderer@2.2.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/ufo@1.6.3/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/node-mock-http@1.0.4/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/unstorage@1.17.4_db0@0.3.4_ioredis@5.9.2/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/unstorage@1.17.4_db0@0.3.4_ioredis@5.9.2/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/youch@4.1.0-beta.13/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/devalue@5.6.2/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/vue@3.5.28_typescript@5.9.3/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/wahyu/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/unhead@2.1.4/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/vue@3.5.28_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/unhead@2.1.4/node_modules/unhead/dist/utils.mjs';
import { basename } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/node_modules/.pnpm/@iconify+utils@3.1.0/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/apps/dashboard/.nuxt/nuxt-icon-server-bundle.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/apps/dashboard/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/apps/dashboard","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/apps/dashboard/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/apps/dashboard/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/apps/dashboard/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/apps/dashboard/.data/kv"}));
...
const _W_ueovzHQsmQbWt311gsGPk_e3IV0en6tJQ2mgBmUgk = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/apps/dashboard";
...
const _5v2_sjtJIUEVrL6E51VGg5Qf7VqSdHw8Z_MKQqxkGC8 = (nitroApp) => {
...
const _Fnm1eE5jUfSnI9qqFui8dh0d6mS3FveUhQ_7dGayxE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _W_ueovzHQsmQbWt311gsGPk_e3IV0en6tJQ2mgBmUgk,
_5v2_sjtJIUEVrL6E51VGg5Qf7VqSdHw8Z_MKQqxkGC8,
_Fnm1eE5jUfSnI9qqFui8dh0d6mS3FveUhQ_7dGayxE
];
...
const __qs_GG = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/apps/dashboard/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///Users/wahyu/Documents/Dev/Projects/butuhbantuan-monorepo/apps/dashboard/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _GEJDV6 = defineCachedEventHandler(async (event) => {
...
const _lazy_mZTNZJ = () => Promise.resolve().then(function () { return customers$1; });
const _lazy_eT_dTF = () => Promise.resolve().then(function () { return mails$1; });
const _lazy_N7PWYZ = () => Promise.resolve().then(function () { return members$1; });
const _lazy_4Hx7YA = () => Promise.resolve().then(function () { return notifications$1; });
const _lazy_U2_RoN = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: __qs_GG, lazy: false, middleware: true, method: undefined },
  { route: '/api/customers', handler: _lazy_mZTNZJ, lazy: true, middleware: false, method: undefined },
  { route: '/api/mails', handler: _lazy_eT_dTF, lazy: true, middleware: false, method: undefined },
  { route: '/api/members', handler: _lazy_N7PWYZ, lazy: true, middleware: false, method: undefined },
  { route: '/api/notifications', handler: _lazy_4Hx7YA, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_U2_RoN, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _GEJDV6, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_U2_RoN, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_U2_RoN, lazy: true, middleware: false, method: undefined }
];
